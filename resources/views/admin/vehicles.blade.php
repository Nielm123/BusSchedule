...
<div class="container-fluid">
            ...
            @foreach($vehicles as $vehicle)
                <tr>
                    ...
                    <form action="{{route('admin.vehicle-delete')}}" method="POST">
                        ...
                        <th class="px-4 py-2"><button class="m-5 bg-red-700 rounded p-1 hover:text-white" >{{__('Delete')}}</button></th>
                    </form>
                </tr>
            @endforeach
            </tbody>
    ...
    @endif
        ...
        <div class="flex justify-center p-10 bg-indigo-50">
            <form action="{{route('admin.vehicleCreate')}}" method="post" class="w-full max-w-lg">
                @csrf
                @method('post')
